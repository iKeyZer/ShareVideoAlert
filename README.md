...
> **AVISO:** Por el momento el programa funciona unicamente con el chat abierto. Proximamente se agregara soporte para activar la alerta mediante puntos del canal, donaciones de Bits y donaciones de dinero.
